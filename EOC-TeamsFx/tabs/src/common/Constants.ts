...
export const defaultChannelConstants = {
    ...
    Planning: "Planning",
    Recovery: "Recovery",
    ERGLNO: "Liaison Officer",
    ERGIC: "Incident Commander",
    ERGPSA: "Principal Scientific Advisor",
    ERGPIO: "Public Information Officer",
    ERGPlanning: "Planning",
    ERGFIN: "Finance",
    ERGLOGS: "Logistics",
    ERGIT: "Information Technology",
    ERGClinOps: "Clinical Operations",
    ERGProvComms: "Provider Communications",
    ERGCHEFO: "Citywide Health Emergency Field Operations",
    ERGHSSB: "Healthcare Systems Support",
    ERGLAB: "Laboratory",
    ERGSurvEpi: "Surveillance and Epidemiology",
    ...
    ERGSF: "Schools and Families",
    ERGIDT: "Integrated Data Team"
};
